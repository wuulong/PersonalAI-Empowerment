...
在這一章中，我們共同跨越了賦能路徑上最險峻的陡坡。如果你已經完成了上述的 11 個練習，你已經在不知不覺中，從一個「等待答案的人」，進化成了一個「佈署系統的人」。

### 🛠️ 從實戰中贏回時間：你可以處理的情境

透過第十章的「抗重力訓練」，你現在已經具備處理以下現實生活與工作情境的能力：

-   **面對混亂的資料搬遷**：當你有 500 張照片或 200 份 PDF 需要重新命名並按類別自動分送至不同目錄時，你不再需要手動點擊，而是撰寫一個「意向指令」，讓代理人為你開發並運行腳本。
-   **面對跨軟體的重複勞動**：當你需要把 Excel 的數據轉化為地圖點位並存入資料庫時，你可以調用 MCP 工具，實現工具間的「聯覺」協作，一次完成原本需要三套軟體才能解決的任務。
